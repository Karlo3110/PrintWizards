  ...
  return (
    <div className="w-[full] h-[80vh] pattern-tech flex justify-center items-center flex-col">
      ...
      <div className="flex justify-center items-center flex-wrap mt-4">
        <button className="text-xl rounded-full bg-sky-400 border hover:bg-sky-200 border-black h-10 w-auto text-center pl-4 pr-4 mr-2 ml-2">
          Contact Us
        </button>
        <button className="text-xl rounded-full bg-white hover:bg-sky-200 border border-black h-10 w-auto text-center pl-4 pr-4 mr-2 ml-2">
          Discord
        </button>
      </div>
    </div>
